	...
	<div class='dashboard'>
		...
		<div class='dashboard-app'>
			...
			<div class='dashboard-content'>
				...
				int hethang = dao2.getFashionsExpired().size();
				DecimalFormat formatter = new DecimalFormat("###,###,###.##");
				%>
				<div class='container'>
					<div class='card'>
						<div class="info-dashs">
<div class="info-dash card-header" style="background: linear-gradient(45deg, #2ed8b6, #59e0c5);">
    <p style="font-size: 18px;">SẢN PHẨM ĐÃ BÁN HẾT</p>
    <p>
