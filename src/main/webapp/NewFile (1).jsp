...
<canvas id="myBarChart" width="<%= 0.4 %>" height="<%= 0.4 %>"></canvas>
<%
        ...
        options: {
            scales: {
                x: {
                    ...
                    labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
                    ticks: {
                        fontSize: 20, // Kích thước chữ cho trục x
                    }
                },
                y: {
                    beginAtZero: true,
                    ticks: {
                        fontSize: 20, // Kích thước chữ cho trục y
                    }
                }
            },
            plugins: {
                legend: {
                    labels: {
                        fontSize:20 // Kích thước chữ cho chú thích
                    }
                }
            }
        }
